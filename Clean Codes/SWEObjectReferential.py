...
vmax = 0.5*(hd*g)**(0.5) #Speed
U = vmax/c0 #Rescaled speed
...
No_Slip0 = DirichletBC(E.sub(0),  Expression(("-U/epsilon","0.0"), U=U, epsilon=epsilon, c0=c0), NoSlip_boundary)
...
u_0 = Expression(("-U/epsilon", "0.0"), U=U, epsilon=epsilon,c0=c0) #Initialisation of the velocity
...
F += 1./dt*(eta-eta_prev)*xi*dx + div((h+epsilon*eta)*(u-vObject/epsilon))*xi*dx
